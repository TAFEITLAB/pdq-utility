...
REM | ======================
REM | DISABLE ADOBE UPDATES
REM | ======================
REM | Purpose: 
REM | - Disable automatic updates to ADobe products.
REM | Requirements: 
REM | - "Include Entire Directory" option is ticked in PDQ Deploy
REM | - Script in same directory as files:
REM | -- disable_adobe_acrobat_updates_ARM.reg
REM | -- disable_adobe_acrobat_updates_DC.reg
REM | -- disable_adobe_acrobat_updates_ReaderDC.reg
REM | Author: Tim Dunn
...
regedit /s disable_adobe_acrobat_updates_ARM.reg
regedit /s disable_adobe_acrobat_updates_DC.reg
regedit /s disable_adobe_acrobat_updates_ReaderDC.reg
