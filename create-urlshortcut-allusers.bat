...
REM | =============================================
REM | Create URL Shorcut for All Users
REM | =============================================
REM | Purpose: Create URL shortcut on the Public Desktop for all users
REM | Requirements:
REM |   - Script must be in same folder as nircmd.exe
REM |   - "Include Entire Directory" option is ticked in PDQ Deploy package. 
REM |   - Two arguments included in PDQ Deploy package, enclosed in quote marks
REM |   -- Argument one: Target URL
REM |   -- Argument two: Desired shortcut name
REM |   --- e.g. "http://wiki:8080/xwiki" "TAFEITLAB Wiki"
REM | Author: Tim Dunn
...
nircmd.exe urlshortcut %1 "%TARGETFOLDER%" %2
